/* SERVICES registry — sections rendered top→bottom on Quicklinks.
 *
 * Status is a static hint ("up" | "warn" | "down" | "off"). Live health
 * is overlaid by useHealth/useServiceHealth at render time.
 *
